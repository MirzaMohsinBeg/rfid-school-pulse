...
const Login = () => {
  ...
  const demoCredentials = [{
    ...
    email: 'store@school.com',
    password: 'store123',
    role: 'Store Manager',
    icon: Store
  }];
  return <div className="min-h-screen bg-gradient-to-br from-primary/20 via-background to-secondary/20 flex items-center justify-center p-4">
      <div className="w-full max-w-md space-y-6">
        ...
        <Card>
          ...
          <CardContent className="space-y-2">
            ...
            return <Button key={index} variant="outline" className="w-full justify-start text-left h-auto p-3" onClick={() => {
              setEmail(cred.email);
